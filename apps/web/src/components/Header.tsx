...
const Header: React.FC = () => {
  ...
  // Renderiza opción según rol recibido de la API (ahora como string)
  const renderProfileMenuItem = () => {
    if (!user) return null;
    
    // Rol "institution" → Muro de Institución
    if (user.role === 'institution') {
      return (
        <Link to="/muro-institucion" className="dropdown-item">
          Muro de Institución
        </Link>
      );
    }
    
    // Cualquier otro rol (admin, normal, publicante, etc.) → Perfil
    return (
